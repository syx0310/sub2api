...
func SetupRouter(
	...
	if web.HasEmbeddedFrontend() {
		frontendServer, err := web.NewFrontendServer(settingService) //nolint:staticcheck // embed build can return nil error; non-embed stub always errors.
		if err != nil {                                              //nolint:staticcheck // see NewFrontendServer build-tag behavior above.
