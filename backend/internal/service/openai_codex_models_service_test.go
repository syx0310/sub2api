...
func TestCompleteAPIKeyCodexModelsManifestForClientMarksOnlyOfficialVisionGPTImageInput(t *testing.T) {
	...
	svc := &OpenAIGatewayService{}
	manifest := &CodexModelsManifest{Body: []byte(`{"models":[{"slug":"gpt-5.6-sol"},{"slug":"gpt-4o"},{"slug":"gpt-5.3-codex-spark","input_modalities":["text","image"],"supports_image_detail_original":true},{"slug":"gpt-3.5-turbo"},{"slug":"gpt-4"}]}`)}
