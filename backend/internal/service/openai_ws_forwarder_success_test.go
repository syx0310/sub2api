...
func TestOpenAIGatewayService_Forward_WSv2_OAuthPreservesValidNativeToolItemID(t *testing.T) {
	gin.SetMode(gin.TestMode)
	...
	require.Equal(t, "fc_hotfix_probe", gjson.Get(requestJSON, "input.0.id").String(), "latest Codex accepts any non-empty prefix_suffix item ID regardless of tool subtype")
