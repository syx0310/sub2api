...
func (s *OpenAIGatewayService) forwardGrokChatCompletionsViaResponses(
	...
	// Include and store are Codex-specific defaults and are not needed by the
	// Grok CLI protocol. Explicit compatibility instructions from the client,
	// however, must survive the Chat-to-Responses bridge.
