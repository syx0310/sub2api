...
func groupBillsOpenAIFastAtStandard(apiKey *APIKey, account *Account, model, serviceTier string) bool {
	...
	if !openAIModelSupportsPriorityServiceTier(model) {
		return false
	}
...
func (s *OpenAIGatewayService) RecordUsage(ctx context.Context, input *OpenAIRecordUsageInput) error {
	...
	if groupBillsOpenAIFastAtStandard(apiKey, billingAccount, firstUsageBillingModel(billingModels), serviceTier) {
