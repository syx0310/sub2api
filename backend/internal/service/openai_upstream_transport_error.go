...
func (s *OpenAIGatewayService) handleOpenAIUpstreamTransportError(ctx context.Context, c *gin.Context, account *Account, err error, passthrough bool) error {
	...
	if !s.openAITransportErrorFailoverEnabled(ctx) {
		writeOpenAITransportErrorResponse(c)
...
func (s *OpenAIGatewayService) openAITransportErrorFailoverEnabled(ctx context.Context) bool {
	if s == nil {
		return false
	}
	if s.settingService != nil {
		return s.settingService.IsOpenAITransportErrorFailoverEnabled(ctx)
	}
	return s.cfg != nil && s.cfg.Gateway.OpenAITransportErrorFailoverEnabled
}

func writeOpenAITransportErrorResponse(c *gin.Context) {
