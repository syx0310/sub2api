...
func TestRecordCyberPolicyIfMarked_NoMark(t *testing.T) {
	...
	h.recordCyberPolicyIfMarked(c, nil, nil, nil, "gpt-5", true, nil, service.ChannelUsageFields{}, "", nil, nil)
...
func TestRecordCyberPolicyIfMarked_WithMark(t *testing.T) {
	...
	require.NotPanics(t, func() {
		h.recordCyberPolicyIfMarked(c, nil, nil, nil, "gpt-5", false, nil, service.ChannelUsageFields{}, "", nil, nil)
	})
...
func TestRecordCyberPolicyIfMarked_ForwardSuccessSkipsUsageLog(t *testing.T) {
	...
	require.NotPanics(t, func() {
		h.recordCyberPolicyIfMarked(c, nil, nil, nil, "gpt-5", false /* forwardErrored=false */, nil, service.ChannelUsageFields{}, "", nil, nil)
	})
	require.True(t, c.GetBool(cyberPolicyRecordedKey))
}
...
func TestRecordCyberPolicyIfMarked_BlockKeyPlumbed(t *testing.T) {
	...
	h := &OpenAIGatewayHandler{}
	require.NotPanics(t, func() {
		h.recordCyberPolicyIfMarked(c, nil, nil, nil, "gpt-5", true, []byte(`{"input":"deadbeef"}`), service.ChannelUsageFields{}, "", nil, nil)
	})
}
