...
func (h *DashboardHandler) GetModelStats(c *gin.Context) {
	...
	stats, hit, err := h.getModelStatsCached(c.Request.Context(), startTime, endTime, userID, apiKeyID, accountID, groupID, model, modelSource, requestType, stream, nativeCompactionV2, billingType, billingMode, upstreamModelMismatch)
	if err != nil {
