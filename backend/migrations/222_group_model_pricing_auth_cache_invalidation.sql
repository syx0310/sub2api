-- Keep the durable group invalidation trigger aligned with every group field
-- materialized into the API-key authentication snapshot. Earlier local
-- migrations added Live/reasoning and profit-control fields independently;
-- this migration preserves their union and adds the v0.1.176 pricing fields.
