...
var (
	...
	CompositeModelRoutesTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "idx_composite_model_routes_unique_active",
				Unique:  true,
				Columns: []*schema.Column{CompositeModelRoutesColumns[12], CompositeModelRoutesColumns[8], CompositeModelRoutesColumns[5], CompositeModelRoutesColumns[4]},
				Annotation: &entsql.IndexAnnotation{
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "response_body_bytes", Type: field.TypeInt64, Nullable: true},
		{Name: "image_count", Type: field.TypeInt, Default: 0},
