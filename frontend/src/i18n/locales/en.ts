  ...
  admin: {
    ...
    accounts: {
      ...
      oauth: {
        ...
        openai: {
          ...
          codexSessionAuth: 'Codex Session JSON Batch Import',
          codexSessionDesc: 'Paste Codex OAuth/session JSON. Accounts use the step 1 settings.',
          codexSessionInputLabel: 'Codex OAuth/session JSON',
          codexSessionPlaceholder: 'Multiple lines supported, one OAuth token JSON or session JSON per line',
          ...
          codexSessionEmpty: 'Please enter Codex OAuth/session JSON',
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        openaiTransportErrorFailover: 'OpenAI Transport Error Failover',
        openaiTransportErrorFailoverHint: 'Default off. When enabled, OpenAI upstream transport errors such as proxy, DNS, TCP, or TLS failures can switch to another account; persistent proxy/network faults temporarily unschedule the account.',
      ...
      webSearchEmulation: {
        ...
        apiKeyPlaceholder: 'Enter API Key',
        apiKeyConfigured: 'Configured',
        apiBaseUrl: 'Tavily API Base URL',
        apiBaseUrlPlaceholder: 'https://example.com/api/tavily',
        apiBaseUrlHint: 'Required for Tavily Hikari. Use the HTTP API base URL, for example https://host/api/tavily; do not use the MCP URL /mcp.',
        showApiKey: 'Show',
        hideApiKey: 'Hide',
        copyApiKey: 'Copy',
        copied: 'Copied',
