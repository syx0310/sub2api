  ...
  admin: {
    ...
    accounts: {
      ...
      oauth: {
        ...
        openai: {
          ...
          codexSessionAuth: 'Codex Session JSON 批量导入',
          codexSessionDesc: '粘贴 Codex OAuth/session JSON，按第一步配置创建账号。',
          codexSessionInputLabel: 'Codex OAuth/session JSON',
          codexSessionPlaceholder: '支持多行，每行一个 OAuth token JSON 或 session JSON',
          ...
          codexSessionEmpty: '请输入 Codex OAuth/session JSON',
          ...
          codexPatDesc: '输入 Codex 生成的 at- 开头 Personal Access Token，系统会先调用 OpenAI whoami 验证并创建账号。',
          codexPatInputLabel: 'Codex PAT',
          codexPatPlaceholder: 'at-...',
          codexPatHint: '这是独立验证方式，不会保存 refresh_token，也不会写入 OAuth access_token 过期时间。',
          codexPatImportAndCreate: '验证并创建 Codex PAT 账号',
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        openaiTransportErrorFailover: 'OpenAI 传输层错误 Failover',
        openaiTransportErrorFailoverHint: '默认关闭。开启后，OpenAI 上游代理、DNS、TCP、TLS 等传输层错误可切换到其他账号；持久性代理/网络故障会临时下线该账号。',
